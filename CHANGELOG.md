...
### Added
- OmniVoice non-verbal expression tags in the Script Mode palette and insertion guide, driven by catalog metadata. Existing Higgs emotion/style controls remain available.
- Documented the 13 OmniVoice symbols, CMU pronunciation syntax, and the distinction from voice-design instructions.
