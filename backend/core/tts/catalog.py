...
_CATALOG: Dict[str, ModelCapabilities] = {
    ...
    "omnivoice-0.2": ModelCapabilities(
        ...
        description="Expressive voice cloning for 600+ languages with inline non-verbal tags; requires WAV and TXT",
        inline_tags=[
            {'token': '[laughter]', 'label': 'Laughter', 'description': 'Risata'},
            {'token': '[sigh]', 'label': 'Sigh', 'description': 'Sospiro'},
            {'token': '[confirmation-en]', 'label': 'Confirmation en', 'description': 'Interiezione di conferma: en'},
            {'token': '[question-en]', 'label': 'Question en', 'description': 'Interiezione interrogativa: en'},
            {'token': '[question-ah]', 'label': 'Question ah', 'description': 'Interiezione interrogativa: ah'},
            {'token': '[question-oh]', 'label': 'Question oh', 'description': 'Interiezione interrogativa: oh'},
            {'token': '[question-ei]', 'label': 'Question ei', 'description': 'Interiezione interrogativa: ei'},
            {'token': '[question-yi]', 'label': 'Question yi', 'description': 'Interiezione interrogativa: yi'},
            {'token': '[surprise-ah]', 'label': 'Surprise ah', 'description': 'Interiezione di sorpresa: ah'},
            {'token': '[surprise-oh]', 'label': 'Surprise oh', 'description': 'Interiezione di sorpresa: oh'},
            {'token': '[surprise-wa]', 'label': 'Surprise wa', 'description': 'Interiezione di sorpresa: wa'},
            {'token': '[surprise-yo]', 'label': 'Surprise yo', 'description': 'Interiezione di sorpresa: yo'},
            {'token': '[dissatisfaction-hnn]', 'label': 'Dissatisfaction hnn', 'description': 'Interiezione di insoddisfazione: hnn'},
        ],
        inline_tag_guidance="Inserisci i tag tra parentesi quadre nel punto della battuta in cui desideri il suono. Sono vocalizzazioni, non comandi per rendere emotiva l'intera frase. Esempio: Alice: [laughter] You really got me. [sigh] Per la pronuncia inglese puoi scrivere fonemi CMU maiuscoli, ad esempio [B EY1 S]. Whisper e accento sono attributi di voice design upstream, non tag inline: questa integrazione usa voice cloning con WAV e TXT, senza istruzioni aggiuntive. I tag Higgs <|emotion:...|> non sono intercambiabili con questi simboli. L'effetto dipende dalla voce e dal contesto: verifica il risultato ascoltandolo.",
